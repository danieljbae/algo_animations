...
class Demo(Scene):
    ...
    def showArray(self):
        ...
        self.num_3 = Tex("3").move_to(4.5 * LEFT)
        self.num_4 = Tex("4").move_to(3.5 * LEFT)
        self.num_9 = Tex("9").move_to(2.5 * LEFT)
        self.num_1 = Tex("1").move_to(1.5 * LEFT)
        self.num_7 = Tex("7").move_to(0.5 * LEFT)
        self.num_0 = Tex("0").move_to(0.5 * RIGHT)
        self.num_5 = Tex("5").move_to(1.5 * RIGHT)
        self.num_2 = Tex("2").move_to(2.5 * RIGHT)
        self.num_6 = Tex("6").move_to(3.5 * RIGHT)
        self.num_8 = Tex("8").move_to(4.5 * RIGHT)
    ...
    def _noSwap(self, left_box, right_box, left_value, right_value):
        ...
        brace_text = MathTex(left_value + " \\leq " + right_value).next_to(brace, DOWN)
        # brace_text = Tex("$" + left_value + " \\leq " + right_value + "$").next_to(brace, DOWN)
    ...
    def _swap(self, left_box, right_box, left_value, right_value, left_num, right_num):
        highlight = VGroup(left_box, right_box)
        brace = Brace(highlight, DOWN)
        brace_text = Tex(left_value + "\\text{ }\\textgreater\\text{ }" + right_value).next_to(brace, DOWN)
        result = Tex("Swap").move_to(2 * DOWN)
